...
*   **Nmap & Wireshark:** Network reconnaissance and traffic analysis.
*   **Python (Custom Scripts):** Automation for repetitive security tasks.

## 📜 Key Achievements
*   **Best Performer of the Month (Dec 2024):** Awarded for technical excellence during Red Team operations.
*   **Certified Ethical Hacker (CEH):** Practical application of offensive security principles.
